...
public class MainActivity extends Activity {
    ...
    //Current number of dispatches
    private int tunesAdd = 0;

    // Timestamp of the last click of the return key
    private long lastBackTimestamp = 0;

    // Whether you are recording
    private boolean isRecording = false;

    // Recording start time stamp
    ...
    // Minimum interval (millisecond) that can be recorded during recording
    public static final int RECORD_INTERVAL = 25;

    // The minimum value stored in the recorded data when the tone is switched (used to distinguish the touch tone)
    private static final int TUNE_VAL_STARTED = 1000;

    //Key: timestamp value: pitch value
    ...
    protected void onStart() {
        ...
        /**
         * Asynchronously load sound resources without blocking UI threads
         */
        ...
        recordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRecording) {
                    ...
                    // Store an empty RecordInfo at the end of the recording to mark the end
                    //If there is no button, the identifier is not stored
        ...
        final Handler handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (msg.what == 1) {
                ...
                } else if (msg.what == 3) {         // Tone switching
                    ...
                    Toast.makeText(MainActivity.this, "Tone switch to " + tuneRadio.getText(), Toast.LENGTH_SHORT).show();
                }
            }
        };
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRecording) {
                    Toast.makeText(MainActivity.this, "Recording, don't worry~", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (timeTunesMap.isEmpty()) {
                    Toast.makeText(MainActivity.this, "You don't seem to have a recording. Upload it after the recording is complete.~", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//            Toast.makeText(MainActivity.this, timeTunesMap.toString(), Toast.LENGTH_LONG).show();
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    tuneRadio.performClick();
                    Toast.makeText(MainActivity.this, "Automatically switched to tone " + tuneRadio.getText() +
